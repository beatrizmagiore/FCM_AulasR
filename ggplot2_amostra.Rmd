...
ggplot()+
  geom_density(data = dados, aes(x = height, color="Altura", linetype="Altura", fill="Altura"), alpha=0.5)+
  geom_density(data = dados, aes(x = weight, color="Peso", linetype="Peso", fill="Peso"), alpha=0.5)+
...
dados %>% 
  ...
  ggplot()+
  geom_density(aes(x = Medida, color = `Tipo de medida`, linetype = `Tipo de medida`, fill = `Tipo de medida`), alpha = 0.5)+
  scale_x_continuous(trans = 'log10')+
  scale_color_manual(values = cores[1:2])+
  scale_fill_manual(values = cores[1:2])+
  labs(x = "Medida", y = "Densidade", color = "Tipo de medida", linetype = "Tipo de medida", fill = "Tipo de medida")+
